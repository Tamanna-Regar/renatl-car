...
export const bikesList = [
  ...
  },
  {
    ...
    price: 'Rs 2,905/day',
    image:
      'https://m.media-amazon.com/images/I/71RCJ8dgB-L._SL1500_.jpg',
    specs: {
      model: 'RoadMaster 16',
      rating: '4.1',
      frame: '16" Steel',
  ...
  },
  {
    ...
    price: 'Rs 3,735/day',
    image:
      'https://m.media-amazon.com/images/I/71cmtvdbRhL._SX522_.jpg',
    specs: {
      model: 'Hybrid X18',
      rating: '4.4',
      frame: '18" Aluminum',
  ...
  },
  {
    ...
    price: 'Rs 3,320/day',
    image:
      'https://m.media-amazon.com/images/I/616zet0w+3L._SX522_.jpg',
    specs: {
      model: 'CityRide 17',
      rating: '4.1',
      frame: '17" Aluminum',
  ...
  },
  {
    ...
    price: 'Rs 5,810/day',
    image:
      'https://m.media-amazon.com/images/I/61oQBuwOaXL._SX522_.jpg',
    specs: {
      model: 'Adventure X19',
      rating: '4.5',
      frame: '19" Aluminum',
...
export default function Bikes() {
  ...
  useEffect(() => {
    const loadFleetBikes = () => {
      try {
        ...
        const fleetBikes = fleetVehicles
          .filter((v) => {
        ...
        setBikes((oldBikes) => {
          const combined = [...oldBikes];

          fleetBikes.forEach((fleetBike) => {
            const alreadyExists =
              combined.some(
                (existingBike) =>
                  String(existingBike.id) ===
                  String(fleetBike.id)
              );

            if (!alreadyExists) {
              combined.push(fleetBike);
            }
          });
  ...
  useEffect(() => {
    const checkAndReleaseExpiredBookings = () => {
      ...
      if (!savedBikes) return;

      try {
        let list = JSON.parse(savedBikes);
        ...
        list = list.map(
          (item, index) => {
            ...
            if (
              ...
              normalized.bookingDetails.endDate
            ) {
              const endDate =
                new Date(
                  normalized.bookingDetails.endDate
        ...
        console.error(
          'Error checking expired bookings:',
          error
        );
      }
    };
